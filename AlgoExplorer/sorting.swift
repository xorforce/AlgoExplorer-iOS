...
class sorting{
    ...
    static let bubbleSortAlgo = "begin BubbleSort(list)\n" +
        "\n" +
    ...
    static let  mergeSortAlgo = "mergeSort(array, first, last):\n" +
    ...
    static let insertionSortAlgo = "INSERTION_SORT (A)\n" +
        "\n" +
    ...
    static let quickSortAlgo = "Quicksort(A as array, low as int, high as int){\n" +
        "if (low < high){\n" +
    ...
    static let heapSortAlgo = "MaxHeapify(A, i)\n" +
        "l = left(i)\n" +
        "r = right(i)\n" +
    ...
    static let selectionSortAlgo = "SELECTION-SORT(A)\n" +
    "1.for j ← 1 to n-1\n" +
    "2. smallest ← j\n" +
    "3.for i ← j + 1 to n\n" +
    "4. if A[ i ] < A[ smallest ]\n" +
