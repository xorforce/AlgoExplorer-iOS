...
class DPCode{
    ...
    static let knapsackProgram = "#include<iostream>\n" +
        "using namespace std;\n" +
        "#include<stdio.h>\n" +
    ...
    static let binomialProgram = "#include<iostream>\n" +
    "using namespace std;\n" +
    "class bin\n" +
    "{\n" +
    "int n,k;\n" +
    ...
    static let lcsProgram = "#include <iostream>\n" +
    "\n" +
    "\n" +
    ...
    static let mcmProgram = "#include<cstdlib>\n" +
    "#define SZ 10\n" +
    "using namespace std;\n" +
    " \n" +
    "int table[SZ][SZ];\n" +
