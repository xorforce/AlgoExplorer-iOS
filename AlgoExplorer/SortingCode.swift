...
class SortingCode{
    ...
    static let bubbleSortProgram = "/* C++ Program - Bubble Sort */\n" +
    "\t\t\n" +
    "#include<iostream.h>\n" +
    "#include<conio.h>\n" +
    "void main()\n" +
    ...
    static let mergeSortProgram = "#include<iostream.h>\n" +
    "#include<conio.h>\n" +
    ...
    static let insertionSortProgram = "#include<iostream>\n" +
    " \n" +
    "using namespace std;\n" +
    " \n" +
    "int main()\n" +
    ...
    static let quickSortProgram = "#include<iostream>\n" +
    "#include<conio.h>\n" +
    "using namespace std;\n" +
    "\n" +
    ...
    static let heapSortProgram = "#include <iostream>\n" +
    "using namespace std;\n" +
    "\n" +
    ...
    static let selectionSortProgram = "#include<iostream>\n" +
    " \n" +
    "using namespace std;\n" +
    " \n" +
    "int main()\n" +
